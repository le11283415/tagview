...
import com.xg.tagandpopupdemo.adapter.TagAdapter;
import com.xg.tagandpopupdemo.interfaces.OnTagClickListener;
import com.xg.tagandpopupdemo.interfaces.OnTagSelectListener;
...
public class ActivityFlowTag extends AppCompatActivity {
    ...
    private FlowTagLayout mSelectFlowTagLayout;
    private TagAdapter<String> mSelectTagAdapter;
    ...
    protected void onCreate(
        ...
        mSelectFlowTagLayout = (FlowTagLayout) findViewById(R.id.select_flow_layout);
        mSelectFlowTagLayout.setTagCheckedMode(FlowTagLayout.FLOW_TAG_CHECKED_MULTI);
        mSelectTagAdapter = new TagAdapter<>(this);
        mSelectFlowTagLayout.setAdapter(mSelectTagAdapter);
        mSelectFlowTagLayout.setOnTagSelectListener(new OnTagSelectListener() {
            @Override
            public void onItemSelect(FlowTagLayout parent, List<Integer> selectedList) {
